...
const Home: NextPage = () => {
  ...
  const contractAddress = "0xf9939F1D62CBAB7d58Cf5b371CFae55669b9050c"
  useEffect(() => {
  ...
  function MintButton() {
      ...
      try{
        await (window as any).ethereum.request({
          ...
          params: [{
            ...
            rpcUrls: ['https://goerli.infura.io/v3/d2751300e8454715bdf390b90692918e'],
          }],
        });
        console.log('try');
        setDisabledFlag(true);
    ...
    return <>
    <div className="bg-primary pb-16 flex flex-wrap buttom justify-center">
